...
@project_router.put("/edit-project/", responses={404: {}})
async def edit_project(project: schemas.Project):
    return await services.edit_project(project)


@project_router.delete("/delete-project/", responses={404: {}})
async def delete_project(project_id: int):
    return await services.delete_project(project_id)
